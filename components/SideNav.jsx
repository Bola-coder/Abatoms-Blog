...
const SideNav = () => {
  return (
    ...
    >
      <div className="basis-3/5 md:basis-3/4 md:flex md:justify-evenly">
        <div className="p-3 bg-green-400 w-10/12 rounded-full text-center mt-5 cursor-pointer md:w-12 md:h-12  md:mt-2">
          <h3 className="text-xl font-bold">B</h3>
        </div>
        <div className="flex flex-col justify-center items-center mt-9 w-7/12 text-center cursor-pointer md:basis-1/3 md:mt-0">
      ...
      <div className="basis-2/5 md:basis-1/4 md:flex md:flex-row ">
